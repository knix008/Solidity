...
var ABIString =
  '[{"constant":false,"inputs":[{"name":"x","type":"uint8"}],"name":\
"getRent", "outputs": [{ "name": "", "type": "bool" }], "payable": false,\
"stateMutability": "nonpayable", "type": "function"}, { "anonymous": false,\
"inputs": [{ "indexed": false, "name": "returnValue", "type": "bool" }],\
"name": "roomRented", "type": "event" }]';
